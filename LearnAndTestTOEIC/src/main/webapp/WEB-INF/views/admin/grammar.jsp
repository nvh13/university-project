                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Quản lý ngữ pháp</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="background-color:#343a40; color: white">
                                <h3 class="card-title">Danh sách bài ngữ pháp</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tr>
                                        <th>ID</th>
                                        <th>Tên</th>
                                        <th><button type="button" class='btn btn-block btn-success btn-sm' onclick="redirectAddPage()"><i class="fa fa-plus-square"></i>&nbsp; Thêm bài ngữ pháp</button></th>
                                    </tr>
                                    </thead>
...
<script>
    ...
    function getGrammar(page){
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/grammar?page='+ page +'&per_page=5',
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
                ...
                $.each(result.data, function (key ,value) {
                    $('#grammarBody').append(
                        ...
                        "<td>" + value.id + "</td>" +
                        "<td>" + value.name + "</td> " +
                        "<td> <a href='<c:url value='/admin/grammarDetail?id="+ value.id +"'/>'><button type='button' class='btn btn-block btn-info btn-sm'>Chi tiết</button></a></td>" +
                        "</tr>");
                });
    ...
    function redirectAddPage(){
        window.location.href = "${pageContext.request.contextPath}/admin/grammarDetail/created";
    }
