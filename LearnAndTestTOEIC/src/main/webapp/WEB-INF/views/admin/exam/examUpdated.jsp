...
<head>
    ...
    <title>Cập nhật câu hỏi bài nghe</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Cập nhật bài thi</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h2 class="card-title">Cập nhật bài thi</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
...
<script>
    ...
    function updateExam(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/exam?id='+id,
            type: 'PUT',
    ...
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/examById?id='+id,
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
    ...
    $('#cancelButton').click(function (){
        window.location.href = "${pageContext.request.contextPath}/admin/exam";
    })
</script>
</body>
</html>
