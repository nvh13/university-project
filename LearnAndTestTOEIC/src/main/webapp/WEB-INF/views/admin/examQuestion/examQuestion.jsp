...
<head>
    ...
    <title>Quản lý câu hỏi bài thi</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<c:url value='/admin/exam'/>">Quản lý bài thi</a></li>
...
<script>
    ...
    function getExam(page){
        var url = '${pageContext.request.contextPath}/api/v1/examQuestion?page='+ page +'&per_page=10&id='+exam_id;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
    ...
    function redirectAddPage(){
        window.location.href = "${pageContext.request.contextPath}/admin/examQuestion/created?exam_id="+exam_id;
    }

    function redirectUpdatePage(id){
        window.location.href = "${pageContext.request.contextPath}/admin/examQuestion/updated?exam_id="+exam_id+"&id="+id;
    }
    ...
    function deleteExam(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/examQuestion',
            type: 'DELETE',
    ...
    $('#search').click(function (){
        ...
        var url = '${pageContext.request.contextPath}/api/v1/examQuestion/search?id='+exam_id+"&keyword="+keyword;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
