...
<head>
    ...
    <title>Cập nhật câu hỏi bài thi</title>
                            ...
                            <form id='formSubmit' enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" placeholder="Nhập đoạn văn" id="paragraph" name="paragraph"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Nhóm</label>
...
<script>
    ...
    function updateExam(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/examQuestion?exam_id='+ exam_id +'&id='+id,
            type: 'PUT',
    ...
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/examQuestionById?id='+id,
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
