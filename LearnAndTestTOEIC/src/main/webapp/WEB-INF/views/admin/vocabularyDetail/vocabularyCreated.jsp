                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Thêm từ</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h2 class="card-title">Thêm từ</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
...
<script>
    ...
    function addVocabulary(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/vocabularyDetail?vocabulary_id='+ vocabulary_id +'',
            type: 'POST',
