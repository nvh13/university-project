                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Quản lý từ</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
<script>
    ...
    function getVocabulary(page){
        var url = '${pageContext.request.contextPath}/api/v1/vocabularyDetail?page='+ page +'&per_page=10&id='+vocabulary_id;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
    ...
    function redirectAddPage(){
        window.location.href = "${pageContext.request.contextPath}/admin/vocabularyDetail/created?vocabulary_id="+vocabulary_id;
    }

    function redirectUpdatePage(id){
        window.location.href = "${pageContext.request.contextPath}/admin/vocabularyDetail/updated?vocabulary_id="+vocabulary_id+"&id="+id;
    }
    ...
    function deleteVocabulary(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/vocabularyDetail',
            type: 'DELETE',
    ...
    $('#search').click(function (){
        ...
        var url = '${pageContext.request.contextPath}/api/v1/vocabularyDetail/search?id='+vocabulary_id+"&keyword="+keyword;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
