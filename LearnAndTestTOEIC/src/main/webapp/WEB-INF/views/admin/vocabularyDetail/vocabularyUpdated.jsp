                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">Quản lý từ</li>
                            <li class="breadcrumb-item active">Cập nhật từ</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h2 class="card-title">Cập nhật từ</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id='formSubmit' enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nhập phiên âm" id="spelling" name="spelling">
                                    </div>
                                    <div class="form-group">
                                        <label>Loại từ</label>
                                        <input type="text" class="form-control" placeholder="Nhập loại từ" id="wordType" name="wordType">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Nghĩa</label>
                                        <input type="text" class="form-control" placeholder="Nhập nghĩa" id="meaning" name="meaning">
                                    </div>
                                    <div class="form-group">
                                        <label>Ví dụ</label>
                                        <input type="text" class="form-control" placeholder="Nhập ví dụ" id="example" name="example">
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<script>
    ...
    $('#updatedButton').click(function (){
        ...
        updateVocabulary(formData);
    })
    function updateVocabulary(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/vocabularyDetail?vocabulary_id='+ vocabulary_id +'&id='+id,
            type: 'PUT',
            ...
            success: function (result) {
                window.location.href = "${pageContext.request.contextPath}/admin/vocabularyDetail?id="+vocabulary_id+"&code="+result.code+"&message="+result.message;
            }
        });
    }
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/vocabularyDetailById?id='+id,
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
    ...
    $('#cancelButton').click(function (){
        window.location.href = "${pageContext.request.contextPath}/admin/vocabularyDetail?id="+vocabulary_id;
    })
</script>
</body>
</html>
