                            ...
                            <form id='formSubmit' enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Nhập lời giải thích" name="reason"></textarea>
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<script>
    ...
    $('#createdButton').click(function (){
        ...
        addListening(formData);
    })
    function addListening(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/listeningQuestion?listening_id='+ listening_id +'',
            type: 'POST',
