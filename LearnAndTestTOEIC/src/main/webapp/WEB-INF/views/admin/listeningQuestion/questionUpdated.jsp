                            ...
                            <form id='formSubmit' enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Nhập lời giải thích" id="reason" name="reason"></textarea>
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<script>
    var listening_id = GetURLParameter('listening_id');
    ...
    $('#updatedButton').click(function (){
        ...
        updateListening(formData);
    })
    function updateListening(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/listeningQuestion?listening_id='+ listening_id +'&id='+id,
            type: 'PUT',
    ...
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/listeningQuestionById?id='+id,
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
