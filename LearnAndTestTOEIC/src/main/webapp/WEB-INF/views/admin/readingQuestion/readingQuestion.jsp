...
<head>
    ...
    <title>Quản lý câu hỏi bài đọc</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<c:url value='/admin/reading'/>">Quản lý bài đọc</a></li>
...
<script>
    ...
    function getReading(page){
        var url = '${pageContext.request.contextPath}/api/v1/readingQuestion?page='+ page +'&per_page=5&id='+reading_id;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
    ...
    function redirectAddPage(){
        window.location.href = "${pageContext.request.contextPath}/admin/readingQuestion/created?reading_id="+reading_id;
    }

    function redirectUpdatePage(id){
        window.location.href = "${pageContext.request.contextPath}/admin/readingQuestion/updated?reading_id="+reading_id+"&id="+id;
    }
    ...
    function deleteReading(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/readingQuestion',
            type: 'DELETE',
    ...
    $('#search').click(function (){
        ...
        var url = '${pageContext.request.contextPath}/api/v1/readingQuestion/search?id='+reading_id+"&keyword="+keyword;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
