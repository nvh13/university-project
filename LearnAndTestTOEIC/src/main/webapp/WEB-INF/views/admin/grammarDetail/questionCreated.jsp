                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Thêm bài ngữ pháp</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h2 class="card-title">Thêm bài ngữ pháp</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id='formSubmit' enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Tên</label>
                                        <input type="text" class="form-control" placeholder="Nhập tên bài ngữ pháp" id="question" name="name">
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả ngắn</label>
                                        <input type="text" class="form-control" placeholder="Nhập mô tả ngắn" name="shortDescription">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="30" placeholder="Nhập nội dung" name="content"></textarea>
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<script>
    ...
    $('#cancelButton').click(function (){
        window.location.href = "${pageContext.request.contextPath}/admin/grammar";
    })
</script>
</body>
</html>
