                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="background-color:#343a40; color: white">
                                <h3 class="card-title">Danh sách bài nghe</h3>
                            </div>
                            <!-- /.card-header -->
                    ...
                    $.each(result, function (key ,value) {
                        $('#listeningBody').append(
                            "<tr>" +
                                ...
                                "<td>" + value.image + "</td> " +
                                "<td> <a href='<c:url value='/admin/listeningQuestion?id=" + value.id + "'/>'><button type='button' class='btn btn-block btn-info btn-sm'>Chi tiết</button></a></td>" +
                            "</tr>");
                    });
                }
            });
