                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h2 class="card-title">Cập nhật người dùng (Để trống trường không muốn thay đổi)</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id='formSubmit' enctype="multipart/form-data">
                                ...
                                <div class="card-footer float-right"  style="background-color: #fff">
                                    <button type="button" class="btn btn-success" id="updatedButton" onclick="updateUser()">Xác nhận</button>&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    function updateUser(){
        if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test($('#email').val()) == false && $('#email').val() != ""){
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/api/v1/user?id='+id,
                type: 'PUT',
    ...
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/userById?id='+id,
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
