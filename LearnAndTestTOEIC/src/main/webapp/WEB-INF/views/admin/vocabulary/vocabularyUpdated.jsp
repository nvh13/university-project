...
<head>
    ...
    <title>Cập nhật bài từ vựng</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Cập nhật bài từ vựng</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h2 class="card-title">Cập nhật bài từ vựng</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
...
<script>
    ...
    function updateVocabulary(data) {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/vocabulary?id='+id,
            type: 'PUT',
    ...
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/vocabularyById?id='+id,
            type: 'GET',
            dataType: 'JSON',
            success: function (result) {
