...
<head>
    ...
    <script async src="https://api.countapi.xyz/hit/learnandtesttoeicListening/c91c90c2-5e19-4c3d-ad18-9f6ef58edf0d"></script>
...
<div class="container"  id='anchor'>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" style="font-weight: bold">Bài nghe</li>
                <li class="breadcrumb-item active" aria-current="page" id="part-active"></li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-1"></div>
            <div class="col-10" id="listening"></div>
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-1"></div>
            <div class="col-10" id="listeningBody"></div>
        </div> <!-- end of row -->
...
<script>
    ...
    function getAListening(){
        $.ajax({
            url: '${pageContext.request.contextPath}/api/v1/listeningById?id='+listening_id,
            type: 'GET',
            dataType: 'JSON',
    ...
    function getListeningQuestion(){
        var url = '${pageContext.request.contextPath}/api/v1/listListeningQuestion?listening_id='+listening_id+'&index='+index;
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
    ...
    function part1(data) {
        ...
        $('#listeningBody').append(
            "<div style='text-align: center'><p><img src='${pageContext.request.contextPath}/resources/file/images/listening/"+ data.image +"'></p> " +
            "<p><audio controls>" +
            "<source src='${pageContext.request.contextPath}/resources/file/audio/listening/"+ data.audio +"' type='audio/mpeg'>" +
            "</audio></p></div>" +
    ...
    function part3and4(data){
        ...
        $('#listeningBody').append(
            "<div style='text-align: center'><p><audio controls>" +
            "<source src='${pageContext.request.contextPath}/resources/file/audio/listening/"+ data[0].audio +"' type='audio/mpeg'>" +
            "</audio></p></div>"
        )
        $.each(data, function (key ,value) {
            $('#listeningBody').append(
                "<p><strong>Question "+ number +": </strong>"+value.question +"</p>" +
